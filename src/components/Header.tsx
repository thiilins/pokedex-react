          ...
          <div className="flex items-center gap-2">
              ...
              <select
                ...
                {pokemonTypes.map(type => (
                  <option
                    key={type}
                    value={type}
                    className="bg-background text-white capitalize">
                    {type}
                  </option>
                ))}
              </select>
            ...
            <div className="relative flex-1 sm:flex-none">
              ...
              <select
                ...
                <option value="id-desc" className="bg-background text-white">
                  Nº Decrescente
                </option>
                <option value="name-asc" className="bg-background text-white">
                  Nome A-Z
                </option>
                <option value="name-desc" className="bg-background text-white">
                  Nome Z-A
                </option>
              </select>
            </div>
